...
def calculate_matches(descriptors_1, descriptors_2):
    ...
    # Make matches compatible with filter_matches()
    compatible_matches = []
...
def display_matches(image_1_cv, keypoints_1, image_2_cv, keypoints_2, inlier_matches):
    match_img = cv2.drawMatches(image_1_cv, keypoints_1, image_2_cv, keypoints_2, inlier_matches, None, flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
